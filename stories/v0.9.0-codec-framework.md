...
- [x] **Codec(T)** - 泛型编解码器接口，支持compose/contramap
- [x] **CustomCodec** - 自定义编解码器构建器
- [x] **Base64Codec** - Base64编解码
- [x] **HexCodec** - 十六进制编解码
- [x] **类型安全** - 编译时类型检查
- [x] **错误处理** - 详细的编解码错误信息
...
2. **CustomCodec**: 自定义编解码器构建器
   - 支持任意encode/decode函数对

3. **Base64Codec**: Base64编解码
   - 标准Base64编码/解码
   - 支持padding
